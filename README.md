...
[Sobre](#-sobre-o-projeto) • [Animações](#-animações-implementadas) • [Funcionalidades](#-funcionalidades) • [Tecnologias](#-tecnologias) • [Instalação](#-instalação) • [Estrutura](#-estrutura-do-projeto) • [Autor](#-autor)
